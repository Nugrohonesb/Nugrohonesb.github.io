...
define("DB_USER", 'root');
define("DB_PASSWORD", 'eko25nugoo');
define("DB_NAME", 'db_projectuas');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", '../../backup/db'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'db_projectuas.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
